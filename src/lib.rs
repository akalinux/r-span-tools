...
//! A practical example of this is how [std::time::Duration] and [std::time::SystemTime] handle [std::ops::Add] and [std::ops::Sub].  This is an example that shows how to use [std::time::Duration] to provide the step and rebound values and [std::time::SystemTime] to operate as the range values:
#![doc = "```rust\n"]
